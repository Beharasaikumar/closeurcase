...
export const lawyers: Lawyer[] = [
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Criminal Defense", proficiency: 95 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Civil Matters", proficiency: 92 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu", "Hindi"],
    practiceAreas: [{ name: "Civil Litigation", proficiency: 87 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Property & Real Estate", proficiency: 96 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Family & Matrimonial", proficiency: 88 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Consumer Protection", proficiency: 90 }],
    specializations: ["Consumer Court"],
    legalServices: ["Consumer Complaint", "Consumer Legal Notice", "Consumer Dispute"],
  ...
  },
  {
    ...
    languages: ["English", "Telugu", "Hindi"],
    practiceAreas: [{ name: "Cyber Law & IT Act", proficiency: 94 }],
    specializations: ["Cyber Crime"],
  ...
  },
  {
    ...
    languages: ["English", "Telugu", "Hindi"],
    practiceAreas: [{ name: "Corporate & Commercial", proficiency: 91 }],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Labour & Service Law", proficiency: 90 }],
    specializations: ["Labour & Service"],
    legalServices: ["Employment Dispute", "Wrongful Termination Matter", "Salary / Wage Dispute"],
  ...
  },
  {
    ...
    languages: ["English", "Telugu"],
    practiceAreas: [{ name: "Taxation & Revenue", proficiency: 93 }],
    specializations: ["Tax"],
    legalServices: ["Tax Consultation", "Income Tax Matter", "Tax Dispute"],
  ...
  },
  {
    ...
    languages: ["English", "Telugu", "Hindi"],
    practiceAreas: [{ name: "Direct & Indirect Tax", proficiency: 89 }],
    specializations: ["Tax"],
    legalServices: ["Tax Consultation", "Income Tax Matter", "Tax Dispute"],
  ...
  },
  {
    ...
    languages: ["English", "Telugu", "Hindi"],
    practiceAreas: [{ name: "Environmental & Pollution Control", proficiency: 86 }],
    specializations: ["Environmental Clearance"],
    legalServices: ["NGT Representation", "Pollution Control Compliance"],
...
const allSeedCases: LegalCase[] = [
  ...
  },
  {
    ...
    description:
      "Citizen reached out over WhatsApp about a landlord refusing to refund the security deposit after vacating the rented flat.",
    category: "Property",
    practiceArea: "Property Law",
    ...
    entityInfo: { dateCreated: "2026-08-20T13:10:00Z", dateModified: "2026-08-20T13:10:00Z" },
    files: { files: [] },
    descriptions: { enumFields: DEFAULT_ENUM_FIELDS, enumLookup: {} },
    caseAiAnalysis: null,
  },
  {
    ...
    entityInfo: { dateCreated: "2026-08-22T05:45:00Z", dateModified: "2026-08-22T05:45:00Z" },
    files: { files: [] },
    descriptions: { enumFields: DEFAULT_ENUM_FIELDS, enumLookup: {} },
    caseAiAnalysis: null,
  },
...
export const payments: Payment[] = [
  ...
  commissionPayment({
    ...
    lawyerName: "Swathi Reddy",
    caseId: "CS-91101",
    caseTitle: "Urgent Bail Application — Detention at Cyberabad Police Station",
    grossAmount: 15300,
  }),
  commissionPayment({
    id: "pay_004",
  ...
  commissionPayment({
    ...
    lawyerName: "Srinivas Chowdary",
    caseId: "CS-91102",
    caseTitle: "Ex-parte Injunction — Imminent Illegal Property Demolition",
    grossAmount: 32000,
  }),
  commissionPayment({
    id: "pay_006",
